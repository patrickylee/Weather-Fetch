...
//   $.getJSON("http://api.openweathermap.org/data/2.5/forecast?id=524901&appid={API key}" + city + "uk&units=metric&appid=48a8c111df81fd58c7240c8f432660e7").then(function(data) {
//     console.log(data);
